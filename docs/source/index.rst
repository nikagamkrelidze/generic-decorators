...
like `Castle's legendary DynamicProxy <https://www.castleproject.org/projects/dynamicproxy/>`_), **Generic Decorators** rely on `Roslyn's Source Generators <https://devblogs.microsoft.com/dotnet/introducing-c-source-generators/>`_ for gnerating fast and efficient decorators durinc compile-time.
